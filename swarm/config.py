...
CONFIDENCE_DROP_THRESHOLD: float = _get_float(
    "SWARM_CONFIDENCE_DROP_THRESHOLD", 0.15
)
...
# Idempotency
IDEMPOTENCY_KEY_TTL_SECONDS: int = _get_int(
    "SWARM_IDEMPOTENCY_KEY_TTL_SECONDS", 3600
)
